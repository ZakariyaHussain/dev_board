...
document.getElementById("imogi-btn").addEventListener("click", function(event){
    ...
    document.getElementById("imogi-btn").disabled = true;
    const div = document.getElementById("activity-history");
    const p = document.createElement("p");
    const cardTitle = document.getElementById("card4-title");
    let today = new Date();
